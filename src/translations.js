export const translations = {
  en: {
    ...
    coaches: {
      ...
      jakeBio: [
        "I've been working with children and teenagers in online English education for more than ten years, primarily with students in China and across Asia.",
        "Over time, I realized that many students already understand far more than they think they do. The challenge usually isn't intelligence or effort. It's learning how to confidently express those ideas in English.",
        "That belief shapes the way I teach.",
        "My lessons focus heavily on communication, critical thinking, reading comprehension, and helping students build natural speaking habits through conversation and guided practice. Rather than pushing memorization or scripted answers, I encourage students to actively think, respond, and use English as a real tool for expression.",
        "Parents often tell me they appreciate the calm and supportive atmosphere in lessons, along with the long-term confidence their children begin to develop over time.",
        "Outside of teaching, I currently live in Vietnam and work with students internationally through Exprimio's online coaching program.",
      ],
  ...
  zh: {
    ...
    coaches: {
      ...
      jakeRole: '创始人兼首席教练',
      jakeBio: [
        '我在网络英语教育领域与儿童及青少年共事已逾十年，主要服务中国及亚洲各地的学生。',
        '在长期陪伴中，我发现许多学生其实已经理解了远超自己想象的内容。真正的挑战往往不在于智力或努力程度，而在于如何自信地用英语表达这些想法。',
        '这一信念深刻影响着我的教学方式。',
        '我的课程着重培养沟通能力、批判性思维和阅读理解，并通过对话与引导练习帮助学生养成自然的英语口语习惯。我不鼓励死记硬背或套用模板，而是引导学生主动思考、积极回应，将英语真正用作表达的工具。',
        '家长们常告诉我，他们非常珍视课堂上平和、支持性的氛围，以及孩子在学习过程中逐渐培养出的长久自信。',
        '课余时间，我定居越南，通过Exprimio的在线辅导项目与来自世界各地的学生携手同行。',
      ],
