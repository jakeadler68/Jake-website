export const translations = {
  en: {
    ...
    coaches: {
      ...
      jakeBio: [
        "I've always been fascinated by how people learn, communicate, and grow.",
        "Over the years, that curiosity has led me to explore far more than language itself. I've spent countless hours thinking about confidence, communication, critical thinking, and the small moments that help people better understand both themselves and the world around them.",
        "After more than a decade of working closely with students and families, I founded Exprimio to build the kind of coaching environment I had always envisioned. One where meaningful relationships matter, curiosity is encouraged, and communication is treated as a skill for life rather than simply another school subject.",
        "Today, Exprimio continues to grow around those same ideas, bringing together coaches who believe that learning is most powerful when students feel understood, supported, and excited to explore.",
      ],
  ...
  zh: {
    ...
    coaches: {
      ...
      jakeBio: [
        '你好，我是Jake。',
        '我从事儿童和青少年英语辅导已有十多年，主要面向中国及亚洲各地的学生。',
        '随着时间的推移，我发现大多数学生实际掌握的知识远比他们自以为的要多。挑战通常不在于智力或努力，而在于如何自信地用英语表达这些想法。',
        '这一信念塑造了我所做的一切。',
        '我的课程结合了沟通、阅读、批判性思维和有意义的对话，帮助学生将英语发展为一种真正的自我表达工具。我喜欢和学生一起探索新想法，共同提出问题，并营造一个鼓励好奇心、让错误成为成长机会的环境。',
        '家长们常常告诉我，他们珍视课堂上平静而支持性的氛围，以及孩子们随着时间的推移所建立起的自信。我的目标不仅仅是帮助学生学英语，而是帮助他们成为有思想、自信的沟通者，并对周围的世界充满探索的热情。',
      ],
      haydnBadge: '教练兼雅思专家',
      haydnName: 'Haydn',
      haydnRole: '教练兼雅思专家',
