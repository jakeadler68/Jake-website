export const translations = {
  en: {
    ...
    coaches: {
      ...
      jakeBio: [
        "I've spent more than ten years helping English learners build confidence and communicate more naturally, working primarily with students across China and Asia.",
      ...
      haydnBio: [
        ...
        "My teaching philosophy is built on confidence, authenticity, and meaningful interaction. I create a supportive environment where learners feel comfortable taking risks, sharing their ideas, and developing the skills to communicate naturally. Whether preparing for an exam, advancing professionally, or simply becoming a more confident speaker, my goal is to help learners become independent, capable users of English.",
  ...
  zh: {
    ...
    coaches: {
      ...
      jakeRole: '创始人兼首席教练',
      jakeBio: [
        '我过去十多年来一直致力于帮助英语学习者建立自信、更自然地进行沟通，主要面向中国及亚洲各地的学生。',
      ...
      haydnBio: [
        ...
        '我的教学理念建立在自信、真实和有意义的互动之上。我营造一个支持性的环境，让学习者感到自在地尝试、分享自己的想法，并培养自然沟通的能力。无论是准备考试、提升职业发展，还是仅仅想成为一个更自信的表达者，我的目标都是帮助学习者成为独立、有能力的英语使用者。',
