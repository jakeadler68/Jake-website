export const translations = {
  en: {
    ...
    about: {
      ...
      titleEm: 'Creator',
      p1: 'Originally from Colorado and currently based in Vietnam, Jake has spent over a decade working with students and families across Asia through online education. His approach combines structured language development with a strong focus on confidence, expression, and long-term personal growth.',
      p2: 'After years of working independently with families, Jake founded Exprimio to create a more personalized and relationship-focused alternative to traditional online English education.',
      p3: 'The company continues to expand with the goal of building a small, high-quality team of coaches who share the same student-centered philosophy.',
      p4: '',
      p5: '',
      stat1num: '10+ Years',
  ...
  zh: {
    ...
    about: {
      ...
      title: '关于创始人与',
      titleEm: '创建者',
      p1: 'Jake来自科罗拉多州，目前定居越南，十余年来通过在线教育与亚洲各地的学生及家庭携手共进。他的教学方法将系统性语言发展与自信表达、长期个人成长有机结合。',
      p2: '在多年独立陪伴家庭学习的经历之后，Jake创立了Exprimio，旨在为传统在线英语教育提供一种更个性化、更注重关系的替代方案。',
      p3: '公司持续发展，致力于组建一支志同道合的小规模精英教练团队，共同践行以学生为中心的教育理念。',
      p4: '',
      p5: '',
      stat1num: '10年以上',
      stat1label: '辅导经验',
